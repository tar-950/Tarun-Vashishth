...
resume_string = convert(r"C:\Users\TarunVashishth\Desktop\resume-parser-master (1)\resume-parser-master\neeraj goel.pdf")
...
#         print('\n')
with open(r"C:\Users\TarunVashishth\Desktop\resume-parser-master (1)\resume-parser-master\techatt.csv", 'rb') as f:
    reader = csv.reader(f)
    your_listatt = list(reader)
with open(r"C:\Users\TarunVashishth\Desktop\resume-parser-master (1)\resume-parser-master\techskill.csv", 'rb') as f:
    reader = csv.reader(f)
    your_list = list(reader)
with open(r"C:\Users\TarunVashishth\Desktop\resume-parser-master (1)\resume-parser-master\nontechnicalskills.csv", 'rb') as f:
    reader = csv.reader(f)
